...
int main(int argc, char** argv) {
  ...
  char *filename = "level_2.ppm";
  FILE *f = fopen("level_2.ppm", "r");
  ...
  ennemyList ennemiesList;
  ennemiesList = saveEnnemy(levelarray, &ennemiesList);
  readEnnemy(ennemiesList);
...
/*** Dessin des éléments ***/
    ...
    /* On vérifie si le vaisseau entre en collision*/
