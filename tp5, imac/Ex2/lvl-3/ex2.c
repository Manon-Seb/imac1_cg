...
int main(int argc, char** argv) {
    ...
    SDL_WM_SetCaption("td05 - ex 02", NULL);
    resizeViewport();
    ...
    while(loop) {
        ...
        glPushMatrix();
            //Lune
            glTranslatef(-0.08,-0.3,0.0);
            glColor3ub(200,200,200);
            drawFilledCircle(0.01,40.0,5.0);
        glPopMatrix();
        glPushMatrix();
        	// Mars
        ...
        glPushMatrix();
            ...
            drawFilledCircle(0.008,40.0,5.0);
        glPopMatrix();
        glPushMatrix();
            // Europe
            glTranslatef(0.35,0.3,0.0);
            glColor3ub(240,255,255);
            drawFilledCircle(0.005,40.0,5.0);
        glPopMatrix();
        glPushMatrix();
            // Ganymède
